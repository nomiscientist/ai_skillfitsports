  ...
  return (
    <div className="absolute top-16 right-4 z-50 w-80 bg-[#111827] border border-[#1e293b] rounded-md shadow-lg overflow-hidden">
      <div className="p-4 border-b border-[#1e293b] flex justify-between items-center">
        <h2 className="text-lg font-medium text-orange-400">Export settings</h2>
      ...
      <div className="p-4 space-y-4">
        <div className="space-y-2">
          <div className="flex items-center">
            <label className="text-sm font-medium text-orange-400">Name</label>
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-orange-400">Quality</label>
        ...
        <Button className="w-full bg-orange-500 hover:bg-orange-600 text-white font-medium shadow-md transition-all duration-200 hover:scale-105">
